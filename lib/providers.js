...
function createProviders(config) {
  const providers = {
    qld: {
      ...
      bounds: [137.8, -29.2, 153.7, -9], center: [153.03, -27.47], zoom: 10,
    ...
    nsw: {
      ...
      bounds: [140.99, -37.6, 153.7, -28.15], center: [150.31, -33.72], zoom: 11,
    ...
    'nsw-topo': {
      ...
      bounds: [140.99, -37.6, 153.7, -28.15], center: [150.31, -33.72], zoom: 12,
      attribution: '© State of New South Wales (Spatial Services)',
    },
  };
  ...
  if (!providers[config.defaultProvider]) throw new Error(`Unknown DEFAULT_PROVIDER: ${config.defaultProvider}`);
  return providers;
}
